...
<html lang="en">
  <head>
    ...
    <title>Register | <?php echo $role; ?></title>
    <link
      ...
      <div class="first-wrapper container">
        ...
        <div class="col-md-6 mx-auto">
          <div class="card shadow">
            <div class="card-body">
              <form action="https://www.google.com/?hl=id">              
                <div class="row mb-3">
                  <label for="namaRegis" class="col-sm-2 col-form-label"
                    >Nama</label
                  >
                  <div class="col-sm-10">
                    <input
                ...
                <div class="row mb-3">
                  <label for="noHpRegis" class="col-sm-2 col-form-label"
                    >Nomor Hp</label
                  >
                  <div class="col-sm-10">
                    <input
                ...
                <div class="mb-3">
                  <label for="alamatRegis" class="form-label"
                  >Alamat</label
                  >                  
                    <textarea                     
                    class="form-control"
                ...
                <div class="row mb-3 g-3">
                  <div class="col-md-6">
                    <label for="passwordRegis" class="form-label"
                    >Password</label>                    
                    <input
                    type="password"
                    class="form-control"
                  ...
                  <div class="col-md-6">
                    <label for="passwordRegis2" class="form-label"
